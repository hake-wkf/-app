            ...
            <div className="flex items-center space-x-1.5">
              ...
              {appTab !== 'design' && (
                <button
                  ...
                  className="flex items-center space-x-1.5 px-2.5 py-1 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 text-xs font-medium transition-colors cursor-pointer"
                  title="个人中心"
                >
